/*
  ...
  - Added the required column `termsAndConditions` to the `User` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `weightGoal` to the `User` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "receiveUpdates" BOOLEAN,
...
ADD COLUMN     "weightGoal" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_paypalId_key" ON "Payment"("paypalId");
